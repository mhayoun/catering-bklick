export const dictionaries = {
  he: {
    ...
    card: { from: 'החל מ-', perGuest: 'לאורח', guestsUpTo: 'עד {n} אורחים', viewProfile: 'לפרופיל המלא', estimatedFor: 'הערכה עבור {n} אורחים', matchCount: '{n} התאמות' },
    profile: {
      about: 'קצת עלינו',
      menu: 'התפריט',
      services: 'שירותים נוספים',
  ...
  en: {
    ...
    card: { from: 'From', perGuest: 'per guest', guestsUpTo: 'Up to {n} guests', viewProfile: 'View full profile', estimatedFor: 'estimated for {n} guests', matchCount: '{n} matches' },
    profile: {
      about: 'About us',
      menu: 'Menu',
      services: 'Additional services',
  ...
  fr: {
    ...
    card: { from: 'À partir de', perGuest: 'par invité', guestsUpTo: "Jusqu'à {n} invités", viewProfile: 'Voir le profil complet', estimatedFor: 'estimation pour {n} invités', matchCount: '{n} correspondances' },
    profile: {
      about: 'À propos',
      menu: 'Menu',
      services: 'Services supplémentaires',
