export const seedCaterers = [
  ...
  },
  {
    ...
    kashrutLevels: ['chief_rabbinate', 'mehadrin'],
    cateringTypes: ['dairy'],
    maxGuests: 200,
    priceFrom: 95,
    eventTypes: ['brit', 'shabbat_chatan', 'celebration'],
    menuCategories: ['salads', 'starters', 'main_courses', 'desserts', 'beverages_non_alcoholic'],
  ...
  },
  {
    ...
    menuCategories: ['salads', 'starters', 'main_courses', 'beverages_non_alcoholic', 'beverages_alcoholic'],
  ...
  },
  {
    ...
    menuCategories: ['salads', 'starters', 'main_courses', 'desserts'],
  ...
  },
  {
    ...
    kashrutLevels: ['mehadrin', 'badatz_eda_chareidis'],
    cateringTypes: ['meat'],
    maxGuests: 400,
    priceFrom: 160,
  ...
  },
  {
    ...
    menuCategories: ['salads', 'starters', 'main_courses', 'beverages_non_alcoholic'],
  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        ...
        pricePerGuest: 95,
        minGuests: 20,
        includedCategories: ['salads', 'starters', 'main_courses', 'desserts'],
        addons: [
          { id: 'full-event', name: { he: "שדרוג 'אירוע מלא' (צוות, כלים, הובלה)", en: "'Full event' upgrade (staff, tableware, delivery)", fr: "Supplément 'événement complet' (personnel, vaisselle, livraison)" }, priceType: 'per_guest', amount: 60 }
        ]
      }
