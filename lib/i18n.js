export const dictionaries = {
  he: {
    ...
    nav: { search: 'חיפוש', dashboard: 'הקייטרינגים שלי', admin: 'ניהול אתר', login: 'התחברות', logout: 'התנתקות', addBusiness: 'הוספת עסק' },
    hero: {
  ...
  en: {
    ...
    nav: { search: 'Search', dashboard: 'My Caterers', admin: 'Admin', login: 'Log in', logout: 'Log out', addBusiness: 'List Your Business' },
    hero: {
  ...
  fr: {
    ...
    nav: { search: 'Recherche', dashboard: 'Mes traiteurs', admin: 'Administration', login: 'Connexion', logout: 'Déconnexion', addBusiness: 'Inscrire mon entreprise' },
    hero: {
